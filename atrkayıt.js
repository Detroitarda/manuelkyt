  ...
  if(kmesajc) {
    ...
    if(kmesajembed) {
      ...
      let member2 = member.user
        ...
        kanal.send(embed.setTitle(`Birisi spawn oldu!`)
...
client.on('guildMemberAdd', async (member) => {
  ...
  /////////////////////////
     //Kanal Tanımı
     ////////////////////////////////////////
    let viruskanal = client.channels.cache.get("KANALID")
  ////////////////////////////////////////
  //Güvenlik TanımlarıS
  ////////////////////////////////////////
  ...
  ////////////////////////////////////////
    ...
    .setDescription(`
     ...
     <a:ktff:882155592100233218> Aramıza Hoşgeldin: **${virususer.username}** !
  
     <a:ktff:882155592100233218> Seninle Birlikte: **${member.guild.memberCount}** Kişiyiz
  
     <a:ktff:882155592100233218> <@8803968927548293520> Rolundekiler Senle En Kısa Zamanda İlgilenicek
  
     <a:ktff:882155592100233218> İsmini Ve Yaşını Yazıp Kayıt Olabilirsin.

     <a:ktff:882155592100233218> Hesabın Kuruluş Tarihi: ${moment(member.user.createdAt).format("**DD MMMM YYYY hh:mm:ss**") }
  
     <a:ktff:882155592100233218> Hesabın Güvenlik Durumu: **${viruj}**
    ...
    .setFooter("Atr Register Sistemi")
    ////////////////////////////////////////
    //Kanala Gönderme
    ////////////////////////////////////////
    viruskanal.send(`<@865477301747712011> <@${member.id}>`, hgembed) ;
  })
